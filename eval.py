...
print("Balanced Accuracy: " + str(round(functionality_results["balanced_accuracy"], 3)) + " -- " + str(
    round(robustness_results["balanced_accuracy"], 3)))
print("WeightedF1:        " + str(round(functionality_results["weightedF1"], 3)) + " -- " + str(
    round(robustness_results["weightedF1"], 3)))
